...
%test_begin(unit = VarStatus, id = &TestID);
%test_describe(desc = VarStatus test);
%test_expected(desc = Variables correctly flagged as numeric-character-all missing-partially populated-etc);
