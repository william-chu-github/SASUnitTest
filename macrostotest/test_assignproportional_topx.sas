...
%test_describe(desc = AssignProportional test for rounding without sum correction adjusting top records);
...
%AssignProportional(Parent, Child, Result, Parent, Child, Source1 Source2, Proportion, 1);
